...
const InitialPropertyForRent: React.FC = () => {
    return (
        <div className="mt-[10px] w-full h-auto bg-white flex flex-col items-center justify-center">
            <h2 className="text-[40px] font-bold font-Poppins text-center text-blackColor">Imóveis à alugar</h2>
            <p className="text-center text-[#8E8E93] text-sm font-normal font-Poppins mb-0">
                Encontre e alugue aqui os imóveis que mais combinam contigo.
            </p>
...
export default InitialPropertyForRent;
