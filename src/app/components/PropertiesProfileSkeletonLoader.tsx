...
const PropertiesProfileSkeletonLoader = () => {
    return (
        <div className="cursor-pointer flex flex-col items-center justify-center w-[268px] h-[220px] border border-borderColor rounded-[5px]">
...
export default PropertiesProfileSkeletonLoader;
